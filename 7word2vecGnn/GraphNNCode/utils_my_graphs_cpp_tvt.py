...
def split_data_my(Gs, classes):
    ...
    for g in Gs:
        ...
        if "train" in g:
            ...
            Gs_test.append(g)
            classes_test.append(label)
        else:
            print("can't recognize the g file")
    ...
    ret.append(Gs_valid)
    ret.append(classes_valid)
    ret.append(Gs_test)
    ret.append(classes_tests)
    return ret
...
#         if "train" in g.name:
#             Gs_train.append(g)
#             classes_train.append(g.label)
#         elif "valid" in g.name:
#             Gs_valid.append(g)
#             classes_valid.append(g.label)
#         elif "test" in g.name:
#             Gs_test.append(g)
#             classes_test.append(g.label)
#         else:
#             print("can't recognize the g file")
#
#     random.shuffle(Gs_train)
