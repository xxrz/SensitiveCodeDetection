...
# try, void, volatile, while ,byValue, cast, false, future, generic, inner, operator, outer, rest, true, var , goto ，const,null}
...
def clean_gadget(gadget):
    ...
    # del cleaned_gadget[0]
            # return the list of cleaned lines
    return cleaned_gadget

# if __name__ == '__main__':
#     test=['static audio_usecase_t voice_extn_get_usecase_for_session_idx(const int index)'
# '{'
